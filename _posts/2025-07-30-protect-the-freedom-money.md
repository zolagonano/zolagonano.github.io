---
title: "Protect The Freedom Money (Monero)"
author: Zola Gonano
layout: post
---
...
They _can’t_ create coins out of thin air or steal from other wallets, but even so, just having that much control is a major threat. It totally undermines the idea that Monero is decentralized and trustless.
...
Even if Qubic hasn’t done anything malicious yet, just the fact that they _could_ is enough to mess with the trust in the system. That’s a big deal for a privacy coin like Monero, where trustless operation is kind of the whole point.
